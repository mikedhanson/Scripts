...
BACKUP_NAME="flash"                    # Folder under UNRAID_PATH which will be backed up
...
rclone sync $BACKUP_PATH $RCLONE_REMOTE:/$BACKUP_NAME --bwlimit "08:00,250 22:00,off" --log-level $LOG_LEVEL --log-file=$LOGFILE  --progress #--progress #--dry-run
